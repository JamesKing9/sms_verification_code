package com.cheng.smsverificationcode;
...
public class RegisterByPhone extends AppCompatActivity implements View.OnClickListener {
    ...
    private void InitUI() {
        ...
        btn_getYzm = (Button) findViewById(R.id.btn_verification_code);
        show_password = (Button) findViewById(R.id.btn_register_show_password);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_verification_code: // 发送验证码
                    ...
                    runOnUiThread(new Runnable() { // UI thread
                        ...
                        public void run() {
                            if (time <= 0) {
                                ...
                                btn_getYzm.setBackgroundResource(R.drawable.selector_btn_verification_code);
